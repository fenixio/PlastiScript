...
function main (parameters)
{
  ...
  body = body.setColor (0.67843137254901960784313725490196, 0.70588235294117647058823529411765, 0.70588235294117647058823529411765);
  var xcube = cube
  ({
    center: [0, 0, 0],
    radius: [length, ch, ch]
  ...
  body = body.intersect (xcube.rotateX(45));
  ...
  var motor = body.union ([cube2, cube3,ring, shaft]);  

  var mountinghole = cylinder
  ({
      start: [-depth, 0, 0],
      end: [0, 0, 0],
