      ...
      if ('source' in data) {
        ...
        switch (e) {
          case 'amf':
            ...
            break;
          case 'gcode':
            importScripts(r.baseurl+'csg.js',r.baseurl+'openjscad.js',r.baseurl+'lang.js');
          ...
          case 'obj':
            ...
            break;
          case 'scad':
            importScripts(r.baseurl+'csg.js',r.baseurl+'openjscad.js',r.baseurl+'lang.js',r.baseurl+'underscore.js',r.baseurl+'openscad-openjscad-translator.js');
