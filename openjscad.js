...
// see the various methods below on how to change these
  this.camera = {
    ...
    position: {x:   0,y:  0,z:  200},  // initial position at XYZ
    clip:     {min: 0.5,  max: 1000},  // rendering outside this range is clipped
  };
  this.plate = {
    draw: true,                // draw or not
    size: 400,                 // plate size (X and Y)
  // minor grid settings
    m: {
      i:  1, // number of units between minor grid lines
      r: .8, g: .8, b: .8, a: .15, // color
    },
  // major grid settings
    M: {
      i: 10, // number of units between major grid lines
      r: .6, g: .6, b: .6, a: .3, // color
    },
  };
  this.axis = {
    draw: true,                // draw or not
    x: {
      neg: {r: 1, g: .5, b: .5, a: .6}, // color in negative direction
      pos: {r: 1, g:  0, b:  0, a: .9}, // color in positive direction
    },
    y: {
      neg: {r: .5, g: 1, b: .5, a: .6}, // color in negative direction
      pos: {r:  0, g: 1, b:  0, a: .9}, // color in positive direction
    },
    z: {
      neg: {r: .5, g: .5, b: 1, a: .6}, // color in negative direction
      pos: {r:  0, g:  0, b: 1, a: .9}, // color in positive direction
    },
  };
  this.solid = {
    draw:    true,               // draw or not
    ...
    color:   [0.41,0.59,0.87,1], // default color
  };
...
// the default options
  this.opts = {
    debug: false,
    libraries: ['csg.js','formats.js','openjscad.js','lang.js'],
    openJsCadPath: '',
    useAsync: true,
    useSync:  true,
  };
